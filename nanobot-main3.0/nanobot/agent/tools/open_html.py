    ...
    async def execute(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if not self._linux_browser_ready():
                return (
                    "Error: No usable Linux browser launcher detected. "
                    "Set DISPLAY, WAYLAND_DISPLAY, or BROWSER, or install xdg-open before using open_html."
                )
            ...
            if not opened:
                return (
                    ...
                    "On Linux, also check DISPLAY, WAYLAND_DISPLAY, BROWSER, or xdg-open."
                )
