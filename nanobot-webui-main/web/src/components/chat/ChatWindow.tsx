...
export function ChatWindow() {
  ...
  const handleSend = useCallback(
    (content: string, media?: string[]) => {
      ...
      wsRef.current?.send({ content, media }, currentSessionKey ?? undefined);
    },
      ...
      <div ref={scrollContainerRef} className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden px-4 py-6">
        {messages.length === 0 ? (
          <div className="flex h-full min-h-[300px] flex-col items-center justify-center gap-5">
            <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-white ring-1 ring-border shadow-inner">
              <img
                src="/logo1.png"
                alt="AI System Agent"
            ...
            <div className="text-center space-y-1.5">
              <p className="font-semibold text-foreground/90">AI System Agent</p>
