      ...
      >
        <DialogHeader>
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[rgba(162,188,198,0.35)] dark:bg-[rgba(59,92,105,0.35)]">
              {step === 0 && <AlertCircle className="h-5 w-5 text-[#3B5C69] dark:text-[#A2BCC6]" />}
              {step === 1 && <Key className="h-5 w-5 text-[#3B5C69] dark:text-[#A2BCC6]" />}
            </div>
            <DialogTitle>
          ...
          {step === 0 && (
            <div className="space-y-4">
              <div className="grid gap-3">
                <div className="flex items-center gap-3 rounded-lg border p-3 bg-[rgba(162,188,198,0.16)] dark:bg-[rgba(59,92,105,0.22)]">
                  <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-[rgba(162,188,198,0.35)] dark:bg-[rgba(59,92,105,0.45)]">
                    <span className="text-sm font-semibold text-[#3B5C69] dark:text-[#A2BCC6]">1</span>
                  </div>
              ...
              <div className="flex justify-end">
                <Button onClick={() => setStep(1)} className="gap-2 bg-gradient-to-r from-[#3B5C69] to-[#4B7484] hover:from-[#35525D] hover:to-[#3B5C69] shadow-[0_8px_24px_rgba(162,188,198,0.35)]">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <div className="flex justify-between pt-2">
                ...
                <Button onClick={handleSaveProvider} disabled={updateProvider.isPending || updateAgent.isPending} className="gap-2 bg-gradient-to-r from-[#3B5C69] to-[#4B7484] hover:from-[#35525D] hover:to-[#3B5C69] shadow-[0_8px_24px_rgba(162,188,198,0.35)]">
