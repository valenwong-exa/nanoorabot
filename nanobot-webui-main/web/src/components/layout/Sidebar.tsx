...
const GENERAL_ITEMS: NavItem[] = [
  { path: "/soul", label: "nav.soul", icon: Bot },
  { path: "/server-host", label: "nav.serverHost", icon: Server },
  ...
  return (
    ...
    >
      ...
      <div className={cn(
        ...
        {!collapsed && (
          <img src="/logo.png" alt="AI System Agent" className="h-18 max-w-[140px] w-auto object-contain object-left mix-blend-multiply dark:mix-blend-normal dark:brightness-90" />
        )}
        <button
          onClick={onToggle}
