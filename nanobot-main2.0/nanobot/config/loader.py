...
def load_config(config_path: Path | None = None) -> Config:
    ...
    # The first import of config.schema can happen while tool modules are still
    # in a circular import chain, which leaves forward refs unresolved until we
    # explicitly rebuild them once the runtime is ready to load config.
