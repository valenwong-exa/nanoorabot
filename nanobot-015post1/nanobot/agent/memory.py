...
class MemoryStore:
    ...
    def clear_long_term_memory(self) -> None:
        """Clear persisted long-term memory context and its archival history."""
        self.write_memory("")
        self._write_entries([])
        self._cursor_file.write_text("0", encoding="utf-8")
        self._dream_cursor_file.write_text("0", encoding="utf-8")
