...
def agent(
    ...
    tool_policy: str | None = typer.Option(None, "--tool-policy", help="Dangerous tool policy JSON path"),
    oracle_config: str | None = typer.Option(None, "--oracle-config", help="Oracle config JSON path"),
    oracle_audit: bool = typer.Option(False, "--oracle-audit", help="Enable Oracle audit persistence"),
    oracle_memory: bool = typer.Option(False, "--oracle-memory", help="Enable Oracle memory persistence"),
