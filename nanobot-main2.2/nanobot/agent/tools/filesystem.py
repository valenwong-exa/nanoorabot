...
class ReadFileTool(_FsTool):
    ...
    def description(self) -> str:
        return (
            ...
            "Do not repeatedly re-read the same unchanged range; use the content "
            "you already gathered unless the file changed or you need a different section. "
...
class EditFileTool(_FsTool):
    ...
    def description(self) -> str:
        return (
            ...
            "replace_all, and expected_replacements. Do not use repeated tiny "
            "trial replacements to discover the right anchor. Shows closest-match "
